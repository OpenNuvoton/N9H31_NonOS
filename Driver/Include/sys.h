/**************************************************************************//**
* @file     sys.h
* @brief    N9H31 SYS driver header file
*
* @note
...
/** @addtogroup N9H31_SYS_Driver SYS Driver
  @{
*/

/** @addtogroup N9H31_SYS_EXPORTED_CONSTANTS SYS Exported Constants
  @{
*/
...
typedef enum IRQn {
    ...
    /******  N9H31 Specific Interrupt Numbers *****************************************/
...
/*@}*/ /* end of group N9H31_SYS_EXPORTED_CONSTANTS */


/** @addtogroup N9H31_SYS_EXPORTED_FUNCTIONS SYS Exported Functions
  @{
*/
...
/*@}*/ /* end of group N9H31_SYS_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H31_SYS_Driver */
