/**************************************************************************//**
 * @file     sc.h
 * @brief    N9H31 Smartcard (SC) driver header file
 *
 * @note
...
/** @addtogroup N9H31_SC_Driver SC Driver
  @{
*/

/** @addtogroup N9H31_SC_EXPORTED_CONSTANTS SC Exported Constants
  @{
*/
#define SC_INTERFACE_NUM        2                /*!< Smartcard interface numbers */ /* N9H31 series has only one SC interface */
...
/*@}*/ /* end of group N9H31_SC_EXPORTED_CONSTANTS */


/** @addtogroup N9H31_SC_EXPORTED_FUNCTIONS SC Exported Functions
  @{
*/
...
/*@}*/ /* end of group N9H31_SC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H31_SC_Driver */
