/**************************************************************************//**
* @file     adc.h
* @brief    N9H31 ADC driver header file
*
* @note
...
/** @addtogroup N9H31_ADC_Driver ADC Driver
  @{
*/

/** @addtogroup N9H31_ADC_EXPORTED_CONSTANTS ADC Exported Constants
  @{
*/
...
/*@}*/ /* end of group N9H31_ADC_EXPORTED_CONSTANTS */

/** @addtogroup N9H31_ADC_EXPORTED_FUNCTIONS ADC Exported Functions
  @{
*/
...
/*@}*/ /* end of group N9H31_ADC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H31_ADC_Driver */
