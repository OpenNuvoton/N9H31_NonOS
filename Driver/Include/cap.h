...
* $Revision: 2 $
* $Date: 15/06/12 8:48a $
* @brief    N9H31 CAP driver header file
*
* @note
...
/** @addtogroup N9H31_CAP_Driver CAP Driver
  @{
*/

/** @addtogroup N9H31_CAP_EXPORTED_CONSTANTS CAP Exported Constants
  @{
*/
...
/*@}*/ /* end of group N9H31_CAP_EXPORTED_CONSTANTS */

/** @addtogroup N9H31_CAP_EXPORTED_FUNCTIONS CAP Exported Functions
  @{
*/
...
/*@}*/ /* end of group N9H31_CAP_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H31_CAP_Driver */
