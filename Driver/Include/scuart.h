/**************************************************************************//**
 * @file     scuart.h
 * @brief    N9H31 series Smartcard UART mode (SCUART) driver header file
 *
 * @note
...
/** @addtogroup N9H31_SCUART_Driver SCUART Driver
  @{
*/

/** @addtogroup N9H31_SCUART_EXPORTED_CONSTANTS SCUART Exported Constants
  @{
*/
...
/*@}*/ /* end of group N9H31_SCUART_EXPORTED_CONSTANTS */


/** @addtogroup N9H31_SCUART_EXPORTED_FUNCTIONS SCUART Exported Functions
  @{
*/
...
/*@}*/ /* end of group N9H31_SCUART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H31_SCUART_Driver */
