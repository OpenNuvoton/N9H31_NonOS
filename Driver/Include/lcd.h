...
* @file     lcd.h
* @version  V1.00
* @brief    N9H31 LCD driver header file
*
...
/** @addtogroup N9H31_LCD_Driver LCD Driver
  @{
*/

/** @addtogroup N9H31_LCD_EXPORTED_CONSTANTS LCD Exported Constants
  @{
*/
/// @cond HIDDEN_SYMBOLS
...
enum DIS_PANEL
{
    ...
    DIS_PANEL_FW070TFT,
    DIS_PANEL_FW043TFT,
    DIS_PANEL_ST70IPS1024600,
    DIS_PANEL_ST70IPS2801424,
    DIS_PANEL_CNT,
};
...
/*@}*/ /* end of group N9H31_LCD_EXPORTED_CONSTANTS */

/** @addtogroup N9H31_LCD_EXPORTED_FUNCTIONS LCD Exported Functions
  @{
*/
...
/*@}*/ /* end of group N9H31_LCD_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H31_LCD_Driver */
