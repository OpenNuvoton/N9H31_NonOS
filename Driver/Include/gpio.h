...
* @file     gpio.h
* @version  V1.00
* @brief    N9H31 GPIO driver header file
*
...
/** @addtogroup N9H31_GPIO_Driver GPIO Driver
  @{
*/

/** @addtogroup N9H31_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group N9H31_GPIO_EXPORTED_CONSTANTS */


/** @addtogroup N9H31_GPIO_EXPORTED_FUNCTIONS GPIO Exported Functions
  @{
*/
...
/*@}*/ /* end of group N9H31_GPIO_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H31_GPIO_Driver */
