...
* @file     can.c
* @version  V1.00
* @brief    N9H31 CAN driver source file
*
...
/** @addtogroup N9H31_CAN_Driver CAN Driver
  @{
*/

/** @addtogroup N9H31_CAN_EXPORTED_CONSTANTS CAN Exported Constants
  @{
*/

/*@}*/ /* end of group N9H31_CAN_EXPORTED_CONSTANTS */
...
/** @addtogroup N9H31_CAN_EXPORTED_FUNCTIONS CAN Exported Functions
  @{
*/
...
/*@}*/ /* end of group N9H31_CAN_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H31_CAN_Driver */
