/**************************************************************************//**
* @file     spi.c
* @brief    N9H31 SPI driver source file
*
* @note
...
/** @addtogroup N9H31_SPI_Driver SPI Driver
  @{
*/

/** @addtogroup N9H31_SPI_EXPORTED_CONSTANTS SPI Exported Constants
  @{
*/
/// @cond HIDDEN_SYMBOLS
...
/*@}*/ /* end of group N9H31_EMAC_EXPORTED_CONSTANTS */

/** @addtogroup N9H31_SPI_EXPORTED_FUNCTIONS SPI Exported Functions
  @{
*/
/// @cond HIDDEN_SYMBOLS
...
/*@}*/ /* end of group N9H31_SPI_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H31_SPI_Driver */
