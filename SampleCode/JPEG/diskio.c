...
#define USBH_DRIVE_4    7        /* USB Mass Storage */
    ...
    __attribute__((aligned(32))) BYTE  fatfs_win_buff_pool[FF_MAX_SS];
#else
    static __align(32) BYTE  fatfs_win_buff_pool[FF_MAX_SS] ;       /* FATFS window buffer is cachable. Must not use it directly. */
#endif
BYTE  *fatfs_win_buff;
