...
#define USBD_MAX_SD_SECTOR  256      // unit is sector, 64 sectors = 32KB
#define USBD_MAX_SD_LEN     (128*1024)   // unit is byte, MUST keep USBD_MAX_SD_LEN = USBD_MAX_SD_SECTOR * USBD_SECTOR_SIZE
